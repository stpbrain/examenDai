				...
				document.form.rut.focus();//me posiciono en el campo nuevamente
					...
					if (EsRut(rut)==false){
							alert("El RUT "+rut+" no es válido");
                                                        //Aqui debes programar lo que quieres que haga la pagina cuando el rut no sea válido
                                                       // document.getElementById("rut_medico").value = "";
                                                        //document.getElementById("input").disabled = true;
                                                        
                                                        
							//limpio el valor del campo rut
							//document.getElementById("rut_medico").focus();//me posiciono en el campo nuevamente
						}else{
								if (rut.length==9){
						var la=rut.substring(0,8);
						var digito=rut.charAt(8);
